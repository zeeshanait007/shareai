...
import { Target, TrendingUp, Shield, Zap, RefreshCw, Loader2, Sparkles, FileCheck, BrainCircuit, ArrowRight, Activity, ShieldCheck, BarChart3, Clock } from 'lucide-react';
